...
func TestDrawHeaderButtons_JSONToggleAndCopyFlash(t *testing.T) {
	...
	copyX, copyY, copyW, toggleX, toggleY, toggleW, _, _, _ := drawHeaderButtons(s, headerX, headerY, paneW, false, time.Time{}, false)
	...
	_, _, copyW2, _, _, toggleW2, _, _, _ := drawHeaderButtons(s, headerX, headerY, paneW, true, time.Time{}, false)
	...
	_, _, copyW3, _, _, _, _, _, _ := drawHeaderButtons(s, headerX, headerY, paneW, false, flashUntil, false)
	if copyW3 != copyW {
